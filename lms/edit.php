  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="title" name="title" value="<?php echo  $user_data['title'] ?>">
          <label for="floatingInput">Title</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Author" name="author" value="<?php echo  $user_data['author'] ?>">
          <label for="floatingInput">Author</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="category" name="category" value="<?php echo  $user_data['category'] ?>">
          <label for="floatingInput">Category</label>
        </div>
        <div class="form-floating">
          <input type="number" class="form-control" id="floatingInput" placeholder="published_year" name="published_year" value="<?php echo  $user_data['published_year'] ?>">
          <label for="floatingInput">Published Year</label>
        </div>
        <br>
